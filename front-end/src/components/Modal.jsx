                ...
                <div className="flex w-full ">
                    <div className="flex w-[50%] flex-col  ">
                        <div className="py-2 px-6 gap-5 w-[48px]">
                            <div className="flex bg-[#f3f4f6] w-[348px] gap-1 rounded-[100px] ">
                                <button className="w-[172px] h-[48px] bg-[#0166ff] px-3 py-1 text-[#f9fafb] font-[400] text-[16px] leading-[24px] rounded-[20px] ">Expense</button>
                                <button className="w-[172px] h-[48px] bg-[#16A34A] px-3 py-1 text-[#f9fafb] font-[400] text-[16px] leading-[24px] rounded-[20px] ">Income</button>
                            </div>
                        </div>
                    ...
                    <div className="w-[396px] flex justify-center mx-auto">
                        <div className="flex flex-col gap-[32px]  w-[348px]">
                            ...
                            <input type="text " className="w-[348px] h-[200px] rounded-lg " placeholder="Write here" />
                        </div>
                    </div>
